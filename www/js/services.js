...
.factory('sharedFilterService', ['ApiEndpoint',function(ApiEndpoint){

	console.log('ApiEndpoint',ApiEndpoint);

	var obj = {};
    //obj.str = "http://ennvafoodcart.epizy.com/food_menu.php?till=";
	//obj.str = "http://localhost:8080/SpringBootCRUDApp/foodKartApi/products/";
	obj.str = ApiEndpoint.url+"/";
	obj.sort = "";
	obj.search = "";
	obj.category = "";
	obj.till=0;
	...
	obj.getUrl=function(){
		...
		obj.till=obj.till + 5;
		obj.str=ApiEndpoint.url+"/"+obj.till; // pass the value to url
		//obj.str="http://ennvafoodcart.epizy.com/food_menu.php?till="+obj.till; // pass the value to url

		if(obj.sort!="" && obj.category!=""){
			obj.str= obj.str+"/"+obj.category+"/"+obj.sort;
			//obj.str= obj.str+"&category="+obj.category+"&sort="+obj.sort;
		}
		else if(obj.category!="" ){
			//obj.str= obj.str+"&category="+obj.category;
			obj.str= obj.str+"/"+obj.category;
		}
		else if(obj.sort!=""){
			//obj.str= obj.str+"&sort="+obj.sort;
			obj.str= obj.str+"/"+obj.sort;
		}
